...
public interface CrissCrossPuzzleInterface extends Remote {
    ...
    public char[][] getInitialPuzzle(Integer gameID, Integer seqNum) throws RemoteException;
    public Integer getGuessCounter(Integer gameID, Integer seqNum) throws RemoteException;
    ...
    public Boolean addWord(String word, Integer seqNum) throws RemoteException;
    public Boolean removeWord(String word,Integer seqNum) throws RemoteException;
    public Boolean checkWord(String word, Integer seqNum) throws RemoteException;
